            ...
            <table class="min-w-full bg-white">
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-left py-3 px-4"><a title="Edit" href="<?= base_url("kategori/edit/" . $row['id_kategori']); ?>" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-l">Edit</a>
                                                    <a title="Delete" href="<?= base_url("kategori/delete/" . $row['id_kategori']) ?>" class="bg-red-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-l" onclick="return confirm('Apakah Anda yakin ingin menghapus data ?')">Delete</a></td>
                    </tr>
                    <?php
                        }
                    ?>
